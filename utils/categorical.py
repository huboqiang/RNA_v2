...
class _CategoricalPlotter(object):
    ...
    def establish_colors(self, color, palette, saturation, color_given=None):
...
class _BarPlotter(_CategoricalStatPlotter):
    ...
    def __init__(self, x, y, hue, data, order, hue_order,
                 ...
                 orient, color, palette, saturation, errcolor, colorgiven):
        """Initialize the plotter."""
        self.establish_variables(x, y, hue, data, orient,
                                 order, hue_order, units)
        self.establish_colors(color, palette, saturation, colorgiven)
...
def barplot(x=None, y=None, hue=None, data=None, order=None, hue_order=None,
            ...
            orient=None, color=None, palette=None, saturation=.75,
            errcolor=".26", ax=None, colorgiven=None, **kwargs):
